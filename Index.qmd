...
subtitle: "EMS Research day 2025"
author: "**UCT seminar series: 6 November 2025**"
format: 
  revealjs:
    #incremental: true
    logo: images/SU_horizontal_RGB.png
    slide-number: c/t
    #multiplex: true
    code-copy: true
    code-link: true
...
-   [Happy Git and GitHub for the useR](https://happygitwithr.com/): Jenny Bryan and fellow contributors.

-   [R Packages](https://r-pkgs.org/): Hadley Wickham and Jennifer Bryan

-   [R Forwards](https://forwards.github.io/): Partners with community groups to advance inclusive and open-source software and technologies.

-   [R Forwards package development](https://forwards.github.io/package-dev/): resources of workshops
:::
::::

# Package 1 <img src="images/moveEZ_logo.png" height="120px" style="vertical-align:middle;"/>
...
## Package 2 <img src="images/GPAbin_logo.png" height="120px" style="vertical-align:middle;"/>
...
![](images/CS.jpg){fig-align="center" width="50%"} ![](images/DD.png){fig-align="center" width="50%"}

::: footer
[**Link to 2023 article**](https://www.tandfonline.com/doi/full/10.1080/03610918.2021.1914089); [**Link to 2025 article**](https://rdcu.be/eyfR2)
:::
...
## Methodology step-by-step {.hide-logo}
...
data(missdat)
library(DT)
datatable(missdat, rownames = FALSE, 
...
data(implist)
library(DT)
datatable(implist[[1]], rownames = FALSE, 
          options = list(pageLength = 5))
```
...
:::::: {layout-ncol="3"}
::: column
![](images/Fig2_left-01-01.jpg)
:::

::: column
![](images/Fig2_mid-01.jpg)
:::

::: column
![](images/Fig2_right-01.jpg)
:::
::::::
...
:::::: {layout-ncol="3"}
::: column
![](images/Fig3_left-01.jpg)
:::

::: column
![](images/Fig3_mid-01.jpg)
:::

::: column
![](images/Fig3_right-01.jpg)
:::
::::::
...
-   `G.target`: the default is `NULL` to utilise the group average of the `m` imputations.

:::::: {layout-ncol="3"}
::: column
![](images/Fig4_left-01.jpg)
:::

::: column
![](images/Fig4_mid-01.jpg)
:::

::: column
![](images/Fig4_right-01.jpg)
:::
::::::
...
![](images/Fig5-01.jpg){fig-align="center" width="30%"}
...
-   `compdat`: Complete data matrix representing the input data of `missmi()`. This is only applicable to simulated data.
